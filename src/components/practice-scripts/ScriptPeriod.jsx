...
import { Trash2, ChevronUp, ChevronDown, GripVertical, Clock, Plus, ChevronRight } from "lucide-react";
...
export default function ScriptPeriod({ item, index, onUpdate, onDelete, onMoveUp, onMoveDown, onAddPlay }) {
